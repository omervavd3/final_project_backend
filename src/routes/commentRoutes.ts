...
import { commentDeleteMiddleware, commentEditMiddleware, commentsPostMiddleware } from "../controllers/middlewares";
/**
 * @swagger
 * tags:
 *  name: Comment
 ...
 *         description: Internal server error
 */
  .post("/",authController.autMiddleware, commentsPostMiddleware  ,commentController.create.bind(commentController))
/**
 * @swagger
 * /comments/{id}:
 *   put:
